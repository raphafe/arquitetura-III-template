...
import { EditProductInputDTO, EditProductOutputDTO } from "../dtos/editToProduct.dto"
...
export class ProductBusiness {
  ...
  public getProducts = async (input: any) => {
    ...
    // é opcional essa promise, já que o output tá sendo tipado embaixo
  public editProduct = async (input: EditProductInputDTO) : Promise<EditProductOutputDTO>=> {
    ...
    //  não é necessário essas verificações, pois foram feitas no DTO
